...
Finally, to make the PowerShell profile automatically open to the correct directory, I added
`"startingDirectory": "D:\\code"` property to the profile object.
...
Once again, to make the Ubuntu profile automatically to the correct directory, I added
`"startingDirectory": "\\\\wsl$\\Ubuntu\\home\\blake\\code"` (where `Ubuntu` should be replaced with
the name of your WSL distro and `blake` with your WSL username).
